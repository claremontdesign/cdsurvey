		...
		'surveysQuestionsData' => [
			...
			'columns' => [
				...
				'type' => [
					...
					'filter' => [
						'enable' => true,
						'index' => cd_config('database.surveysQuestions.table.name') . '.type'
					],
					'ui' => [
						'html' => [
							'filterInput' => [
				...
				'status' => [
					...
					'filter' => [
						'enable' => true,
						'index' => cd_config('database.surveysQuestions.table.name') . '.status'
					],
					'ui' => [
						'html' => [
							'filterInput' => [
				...
				'created' => [
					...
					'filter' => [
						'enable' => true,
						'index' => cd_config('database.surveysQuestions.table.name') . '.created_at'
					],
					'sort' => [
						'enable' => true,
					],
